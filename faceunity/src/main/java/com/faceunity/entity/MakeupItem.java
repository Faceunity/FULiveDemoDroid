...
public class MakeupItem {
    ...
    public MakeupItem(int type, int nameId, String intensityName, String colorName, List<double[]> colorList,
    ...
    public MakeupItem(int type, int nameId, String intensityName, Drawable iconDrawable, Map<String, Object> paramMap) {
        this.type = type;
        this.nameId = nameId;
        this.intensityName = intensityName;
        this.iconDrawable = iconDrawable;
