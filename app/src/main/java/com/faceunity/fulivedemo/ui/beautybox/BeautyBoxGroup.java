...
public class BeautyBoxGroup extends LinearLayout {
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        if (child instanceof BaseBeautyBox) {
            final BaseBeautyBox button = (BaseBeautyBox) child;
            if (button.isChecked()) {
                mProtectFromCheckedChange = true;
                if (mCheckedId != -1) {
    ...
    private void setCheckedStateForView(int viewId, boolean checked) {
        ...
        if (checkedView != null && checkedView instanceof BaseBeautyBox) {
            ((BaseBeautyBox) checkedView).setChecked(checked);
        }
    }
    ...
    private class CheckedStateTracker implements BaseBeautyBox.OnCheckedChangeListener {

        @Override
        public void onCheckedChanged(BaseBeautyBox beautyBox, boolean isChecked) {
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == BeautyBoxGroup.this && child instanceof BaseBeautyBox) {
                ...
                ((BaseBeautyBox) child).setOnCheckedChangeListener(
        ...
        public void onChildViewRemoved(View parent, View child) {
            if (parent == BeautyBoxGroup.this && child instanceof BaseBeautyBox) {
                ((BaseBeautyBox) child).setOnCheckedChangeListener(null);
            }
