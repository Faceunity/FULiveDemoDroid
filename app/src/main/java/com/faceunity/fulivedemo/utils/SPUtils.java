...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = FUApplication.getContext().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = FUApplication.getContext().getSharedPreferences(spName, mode);
    }
    ...
    public static SPUtils getInstance() {
        return getInstance(Constant.SHARED_PREF_NAME, Context.MODE_PRIVATE);
    }
