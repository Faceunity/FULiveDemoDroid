...
dependencies {
...
implementation 'com.faceunity:core:8.4.0' 
implementation 'com.faceunity:model:8.4.0' 
...
}
```
...
dependencies {
...
implementation 'com.faceunity:nama:8.4.0' //底层库-标准版
implementation 'com.faceunity:nama-lite:8.4.0' //底层库-lite版
...
}
```
##### 备注
